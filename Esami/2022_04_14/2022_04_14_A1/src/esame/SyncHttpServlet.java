...
/** 
 * Chiedo scusa per eventuali imprecisioni o sviste ma questa è la 
 * soluzione migliore che mi sia venuta in mente per la sincronizzazione delle
 * variabili con scope application, in particolare per le modifiche set e get
 * Attribute che avvengono nel ServletContext.
 * @author Simone Elia
 */
