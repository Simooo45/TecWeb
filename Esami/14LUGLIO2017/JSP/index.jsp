...
<html>
   ...
   <body>
      ...
      <!-- IL FORM QUI SOPRA PERMETTE ALL UTENTE DI INSERIRE I PROPRI DATI E UNA VOLTA CLICCATO IL TASTO "LOG-IN" 
      	LI INVIA ALL PERCOSO RELATIVO LogIn, nel quale è mappata la servlet LogIn (WEB.XML).
      	DI CONSEGUENZA PASSO I DATI LATO SERVER PER FAR SI CHE VENGANO GESTITI ED ELABORATI
		Vedi ../SERVLET/LogIn
		DA NOTARE CHE IL METODO è POST-->
      	<%
